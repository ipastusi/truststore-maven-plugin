...
RESULT=$(keytool -list -keystore target/truststore.uber -storetype uber -storepass topsecret -providerpath ../../../bin/bcprov-jdk15to18-1.70.jar -provider org.bouncycastle.jce.provider.BouncyCastleProvider)
