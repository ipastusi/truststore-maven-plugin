package io.buildlogic.truststore.maven.plugin.it;
...
public class ApiIT {
    ...
    private static final String TRUSTSTORE = "target/truststore_www_google_com.p12";
    ...
    public void testHttpsRequestWithoutServerCertsInTruststore() {
        given().baseUri("https://www.akamai.com")
                .and().trustStore(TRUSTSTORE, TRUSTSTORE_PASSWORD)
                .when().get();
    }
}
