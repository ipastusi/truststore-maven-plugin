...
RESULT=$(keytool -list -keystore target/property_configured_truststore.bcsfks -storepass topsecret -storetype bcfks -providerpath ../../../bin/bcprov-jdk18on-1.72.jar -provider org.bouncycastle.jce.provider.BouncyCastleProvider)
