...
RESULT=$(keytool -list -keystore target/truststore.bks -storetype bks -storepass topsecret -providerpath ../../../bin/bcprov-jdk18on-1.72.jar -provider org.bouncycastle.jce.provider.BouncyCastleProvider)
