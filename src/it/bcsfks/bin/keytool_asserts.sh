...
RESULT=$(keytool -list -keystore target/truststore.bcsfks -storetype bcfks -storepass topsecret -providerpath ../../../bin/bcprov-jdk15to18-1.70.jar -provider org.bouncycastle.jce.provider.BouncyCastleProvider)
