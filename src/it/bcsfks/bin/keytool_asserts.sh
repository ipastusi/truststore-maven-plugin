...
RESULT=$(keytool -list -keystore target/truststore.bcsfks -storetype bcfks -storepass topsecret -providerpath ../../../bin/bcprov-jdk18on-1.71.jar -provider org.bouncycastle.jce.provider.BouncyCastleProvider)
